...
$paypal['business']=PP_MAIN_EMAIL;
$paypal['site_url']=PP_SITE_URL;
$paypal['image_url']=PP_SITE_LOGO;
$paypal['success_url']="success.php";
//$paypal[success_url]="php_paypal/ipn/ipn.php";
$paypal['cancel_url']="error.php";
$paypal['notify_url']=PP_INP_URL;
$paypal['return_method']="2"; //1=GET 2=POST
$paypal['currency_code']=PP_CUR; //[USD,GBP,JPY,CAD,EUR]
$paypal['lc']="GB";
