...
<header>
    ...
    </div><a href="../dashboard.php" class="brand pull-left"><img src="../../build/images/logo/umg.png" alt="" width="100" class="logo"><img src="../../build/images/logo/umg.png" alt="" width="28" class="logo-sm"></a><a href="javascript:;" role="button" class="hamburger-menu pull-left"><span></span></a>
...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header container-fluid">
            <div class="row">
                <div class="col-sm-12 ">
                    <h4 class="mt-0 mb-5" align="center">TIPO INSUMO</h4>
                </div>
            </div>
        </div>
        <div-- class="page-content container-fluid">
            ...
            <did class="row">
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-heading">
                            <h3 class="widget-title">Formulario Tipo Insumo</h3>
                        </div>
                ...
                <div class="row" align="center"><h3>INFORMACION TIPO INSUMOS</h3></div>
                <div class="row">
                    ...
                    <table class="table table-striped col-lg-6" align="center">
                        ...
                        foreach($dataEmp as $row)
                        {
                            ...
                            echo "<tr>";
                            echo "<td aling='center' value=".$row["idEmpleado"].">".$row["idEmpleado"]."</td>";
                            ...
                            echo "<td>";
                            echo "<button type='button' class='btn btn-outline btn-success ti-pencil-alt'  data-toggle='modal' data-target='#myModal' onclick='javascript:consultarEmpleado($idEmpleado);' ></button>"; //jr='edita' id='$idEmpleado'
                            echo "</td>";
                            echo "<td>";
                            echo "<button type='button' class='btn btn-outline btn-danger ti-trash' data-toggle='modal' data-target='.bd-example-modal-sm' onclick='javascript:pasarIdEmpleado($idEmpleado);'></button>";  // id='$idEmpleado'
                            echo "</td>";
                            echo "</tr>";
                        }//end foreach
                        ?>
