...
include_once(APP_INC_PATH.'payment_inc/up_inc.php');
...
<head><meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
    ...
    <title>Upgrading your membership</title>
   ...
   <body onLoad="document.membership_ok.submit();">
            ...
            <div class="jumbotron hero-unit">
             ...
             <form method="POST" name="membership_ok" action="<?php echo $paypal['url'];?>">
                ...
                <input type="hidden" name="item_name" value="<?php echo 'upgrading membership';?>">
