  ...
  <body>
    ...
    <header>
      ...
      <ul class="notification-bar list-inline pull-right">
        ...
        <li class="dropdown"><a id="dropdownMenu1" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"
                                class="dropdown-toggle bubble header-icon"><i class="ti-world"></i><span class="badge bg-danger">6</span></a>
        ...
        <li class="dropdown hidden-xs"><a id="dropdownMenu2" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"
                                          class="dropdown-toggle header-icon lh-1 pt-15 pb-15">
    ...
    <div class="main-container">
      ...
      <aside class="main-sidebar">
        ...
        <ul class="list-unstyled navigation mb-0">
          ...
          <li class="panel">
            <a role="button" href="vistas/dashboard.php" class="bubble active collapse">
          ...
          <li class="panel">
            ...
            <ul id="collapse2" class="list-unstyled collapse">
              ...
              <li><a href="vistas/admon/iProveedores.php" class="active">Proveedor</a></li>
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse3" aria-expanded="false" aria-controls="collapse3" class="collapsed"><i class="ti-folder"></i><span class="sidebar-title">Inventario</span></a>
            <ul id="collapse3" class="list-unstyled collapse">
              ...
              <li><a href="vistas/inventario/iAreas.php">Areas</a></li>
              <li><a href="vistas/inventarioi/Insumos.php">Insumos</a></li>
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse5" aria-expanded="false" aria-controls="collapse4" class="collapsed"><i class="ti-user"></i><span class="sidebar-title">Damnificados</span></a>
            <ul id="collapse5" class="list-unstyled collapse">
              <li><a href="vistas/damnificados/iAlbergues.php">Beneficiario</a></li>
              <li><a href="vistas/damnificados/iBeneficiario.php">Albergue</a></li>
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse6" aria-expanded="false" aria-controls="collapse4" class="collapsed"><i class="ti-bar-chart-alt"></i><span class="sidebar-title">Reportes</span></a>
            <ul id="collapse6" class="list-unstyled collapse">
              <li><a href="vistas/reportes/iViveresEntregadosPorMes.html">Viveres Entregados a cada familia por mes</a></li>
              <li><a href="#">#</a></li>
              <li><a href="#">#</a></li>
            </ul>
          </li>
      ...
      <div class="page-container">
        <div class="page-header container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h4 class="mt-0 mb-5">SISTEMA DE CONTROL DE FAMILIAS BENEFICIADAS ANTE DESASTRES NATURALES</h4>
            </div>
          </div>
        </div>
        ...
        <div class="footer">2016 &copy;  </a></div>
      </div>
