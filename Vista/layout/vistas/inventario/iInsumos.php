<?php
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/SistemaDesastresNaturales/Modelo/BASE_DE_DATOS.php');
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/SistemaDesastresNaturales/Controlador/ESTADO.php');
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/SistemaDesastresNaturales/Controlador/INSUMO.php');
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/SistemaDesastresNaturales/Controlador/BODEGA.php');
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/SistemaDesastresNaturales/Controlador/AREA.php');
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/SistemaDesastresNaturales/Controlador/STOCK.php');
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/SistemaDesastresNaturales/Controlador/tipoInsumo.php');
...
<script type="text/javascript" src="../../../../Controlador/ajax/enviarDataInsumo.js"></script>
