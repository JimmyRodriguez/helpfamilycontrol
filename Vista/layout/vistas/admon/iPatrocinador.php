<?php
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/helpfamilycontrol/BASE_DE_DATOS.php');
...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/helpfamilycontrol/Controlador/tipoPatrocinador.php');
?>
...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header container-fluid">
            <div class="row">
                <div class="col-sm-12 ">
                    <h4 class="mt-0 mb-5" align="center">Patrocinador</h4>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-heading">
                            <h3 class="widget-title">Formulario de Patrocinador</h3>
                        </div>
                        <div class="widget-body">
                            <!--FORMULARO PARA GUARDAR, ELIMINAR Y ACTUALIZAR DATOS DEL PATROCINADOR-->
                            <form>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="nombrePatrocinador">Nombre del Patrocinador</label>
                                            <input id="nombrePatrocinador" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="telefonoPatrocinador">Telefono</label>
                                            <input id="telefonoPatrocinador" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="idTipoPatrocinador">Tipo Patrocinador</label>
                                            <select id="idTipoPatrocinador" class="form-control" >
                                                <option value="">Seleccionar el Tipo</option>
                                                <?php
                                                $tipoPat = new tipoPatrocinador();
                                                $dataTipoPat = $tipoPat->consultarTipoPatrocinador();

                                                foreach($dataTipoPat as $row){
                                                    echo "<option value=".$row["idTipoPatrocinador"].">".$row["nombreTipoPatrocinador"]."</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="fechaInscripcionPatrocinador">Fecha Inscripcion</label>
                                            <input id="fechaInscripcionPatrocinador" type="date" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailPatrocinador">Email</label>
                                            <input id="emailPatrocinador"  type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="direccionPatrocinador">Direccion</label>
                                            <input id="direccionPatrocinador" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-outline btn-success" onclick="nuevoPatrocinador()">NUEVO</button>
                            </form>
                            <!-- finaliza el form -->
                        </div>
                    </div>
                </div>
                <div class="row" align="center"><h3>INFORMACION DE LOS PATROCINADORES</h3></div>
                <div class="row">
                    <table class="table table-striped col-lg-6" align="center">
                        ...
                        $dataPatr = $patrocinador->consultarPatrocindador();

                            if(is_array($dataPatr) == true && isset($dataPatr) == true){

                                foreach($dataPatr as $row){
                                    echo "<tr>";
                                        echo "<td value=".$row["idPatrocinador"].">".$row["idPatrocinador"]."</td>";
                                        ...
                                        echo "<td>";
                                            echo "<button type='button' class='btn btn-outline btn-success ti-pencil-alt' data-toggle='modal' data-target='#myModal'></button>";
                                        echo "</td>";
                                        echo "<td>";
                                             echo "<button type='button' class='btn btn-outline btn-danger ti-trash' data-toggle='modal' data-target='.bd-example-modal-sm'></button>";
                                        echo "</td>";
                                    echo "</tr>";
        ...
        <script type="text/javascript" src="../../../../Controlador/ajax/enviarDataPatrocinador.js"></script>
</body>
</html>